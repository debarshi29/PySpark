...
\begin{equation*}
  \sqrt{(m_{\sin}-m'_{\sin})^2+(m_{\cos}-m'_{\cos})^2}
    = 2\left|\sin\frac{\pi(m-m')}{12}\right|,
\end{equation*}
is a monotone function of their true circular distance and wraps
correctly around the year boundary.
...
\Cref{tab:discount-bucket} operationalises the threshold effect
