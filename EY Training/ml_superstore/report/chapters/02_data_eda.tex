...
Copiers (43\% margin) and Phones (\$330k sales, 13\% margin).
...
\end{figure}
Quantitatively, the loss rate ($\Pr(\text{Profit}<0)$) is \textbf{3\%} for
undiscounted lines and \textbf{over 50\%} for lines discounted 30\% or
more — an order-of-magnitude jump. Because the relationship is a threshold
